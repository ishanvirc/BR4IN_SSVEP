...
|---|---|---|---|
| 01 | [01_data_exploration.ipynb](01_data_exploration.ipynb) | Ishanvir | Raw `(11, N)` `.mat` schema, trigger structure, trial epoching, CH11 → stim-frequency mapping recovery via 24-permutation sweep |
...
| 03 | [03_cca_baseline.ipynb](03_cca_baseline.ipynb) | Ishanvir | CCA against canonical sin/cos refs; per-frequency canonical correlation; cross-subject 4-block LOBO = **0.838 ± 0.163** |
| 04 | [04_fbcca.ipynb](04_fbcca.ipynb) | Ishanvir | 5-sub-band Chebyshev I filter bank; weights `n⁻¹·²⁵+0.25`; squared-ρ aggregation; LOBO = **0.950 ± 0.061** at 3 s, H=2 |
| 05 | [05_trca.ipynb](05_trca.ipynb) | Ishanvir | Generalized eigenvalue solve `S w = λ Q w`; ensemble per-class spatial filters; cross-subject = 0.312, within-subject = 0.475 (subj 1 = 0.675, subj 2 = 0.275); documented negative result with mechanism analysis |
...
| 07 | [07_demo.ipynb](07_demo.ipynb) | VT | Clean presentation demo |
...
All notebooks are committed with executed outputs.