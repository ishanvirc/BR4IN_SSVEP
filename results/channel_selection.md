...
## Final comparison (pending TRCA)

The full classifier comparison (CCA-8ch / CCA-top4-nested / FBCCA / TRCA / CH11) will be generated by `scripts/compare_classifiers.py` once TRCA is implemented. Current status:

| Classifier      | Status  | Accuracy @ 3.0s |
|-----------------|---------|-----------------|
| CCA-8ch         | done    | 83.8%           |
| CCA-top4-nested | done    | 85.0%           |
| FBCCA           | pending | —               |
| TRCA            | pending | —               |
| CH11 (SOTA)     | done    | 87.2% (49% coverage) |
