...
| Classifier      | Status  | Accuracy @ 3.0s | ITR (bpm) | Notes |
|-----------------|---------|-----------------|-----------|-------|
| CCA-8ch         | done    | 83.8%           | 22.0      | |
| CCA-top4-nested | done    | 85.0%           | 23.0      | leakage-free nested CV |
| FBCCA           | pending | —               | —         | expected to underperform on widely-spaced freqs |
| TRCA            | done    | **31.2%**       | 0.3       | negative result — see `results/trca_methodology_note.md` |
| CH11 (SOTA)     | done    | 87.2%           | —         | 49% trial coverage; acc over all trials = 42.5% |
